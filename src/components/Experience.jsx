...
function Experience() {
  return (
    <section>
      <div>
        <h1 className='text-white text-3xl mb-4 font-syne font-bold mt-16'>
          My Experience
        </h1>
      </div>
        ...
        <div className='flex gap-20 mb-20 flex-col sm:flex-row flex-grow'>
          ...
          <div className='flex-1 bg-slate-800  p-4 border rounded-3xl shadow-slate-400 leadin-7'>
            <p className='text-gray-400'>
              <span className='font-semibold'>Name: </span>Cerebrum Dao
            </p>

            <p className='text-gray-400'>
              <span className='font-semibold'>Project Role: </span>Contributor
              (Graphic Designer)
            </p>
            ...
            <p className='text-gray-400'>
              <span className='font-semibold'>Description: </span>Web3
            </p>

            <p className='text-gray-400'>
              <span className='font-semibold'>Scope of the project: </span>
              Monthly Design Projects, Even Announcement Designs, Monthly Report
              Updates, Token Launch Updates etc.
            </p>
          </div>
