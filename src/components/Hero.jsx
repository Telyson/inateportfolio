  ...
  return (
    <section className='flex w-full xl:flex-row flex-col gap-10 justify-center min-h-screen max-container'>
      <div className='xl:w-2/5 flex flex-col justify-center items-start w-full max-xl:padding-x pt-28'>
        ...
        <p className='font-semibold space-x-2 my-4 text-gray-200'>
          Social Media Designs require specific combination of visual appeal and
          clarity while sticking to other design principles, Overall, client
          satisfaction is a key factor and that is why as a graphic designer I
          design with aim to craft visual narratives that simplify complex
          information no matter the Organization or project, my mission is to
          make design easier
        </p>
